  ...
  return (
    <section id="about">
      <Box style={{ paddingTop: "5rem", paddingBottom: "5rem" }}>
        ...
        <img alt="film strip" style={{ maxWidth: "100%", maxHeight: "500px", width: "auto", height: "auto", marginTop: "4rem" }} src="https://d3f9hpbghq9tuf.cloudfront.net/development-process.png" />
        <Typography sx={{ fontSize: "0.75rem", opacity: "0.6", marginTop: "0.5rem" }}>* Photo not included in Solfilm ISO 001</Typography>
      </Box>
    </section>
